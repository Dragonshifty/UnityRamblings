...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Run()
    {
        ...
        bool playerHasHortizonalSpeed = Mathf.Abs(myRigidbody.velocity.x) > Mathf.Epsilon;
        myAnimator.SetBool("isRunning", playerHasHortizonalSpeed);
    }
    ...
    void ClimbLadder()
    {
        ...
        if (myFeetCollider.IsTouchingLayers(LayerMask.GetMask("Climbing")) && Input.GetKey(KeyCode.Space))
            {
                myRigidbody.velocity += new Vector2(0f, jumpSpeed);
            }
    }
